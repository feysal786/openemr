...
function tabs_view_model()
{
    ...
    this.tabsList.push(new tabStatus("One",webroot_url+"/interface/main/main_info.php","cal",true,true,true));
    this.tabsList.push(new tabStatus("Two",webroot_url+"/interface/new/new.php","addp",true,true,false));
//    this.tabsList.push(new tabStatus("Three",webroot_url+"/interface/patient_tracker/patient_tracker.php?skip_timeout_reset=1","msgg",true,false,false));
